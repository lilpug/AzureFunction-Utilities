...
[assembly: FunctionsStartup(typeof(AzureFunction.Utilities.Startup))]

namespace AzureFunction.Utilities
{
    public class Startup : FunctionsStartup
    {
        ...
        public override void Configure(IFunctionsHostBuilder builder)
        {
            ...
            builder.Services.AddScoped<IServiceValidationConverter, ServiceValidationConverter>();
